...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Ajouter un pointage') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('pointages.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="heure_pointage" type="datetime-local" class="form-control @error('heure_pointage') is-invalid @enderror" name="heure_pointage" value="{{ old('heure_pointage') }}" required>
